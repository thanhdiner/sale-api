...
const homeBuildYourKitContentRouter = require('./cms/homeBuildYourKitContent.route')
...
const notificationsRouter = require('./commerce/notifications.route')
...
module.exports = app => {
  ...
  app.use(version + '/home-build-your-kit', homeBuildYourKitContentRouter)
  ...
  app.use(version + '/notifications', authenticateToken.authenticateToken, notificationsRouter)
