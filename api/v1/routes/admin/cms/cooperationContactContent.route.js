...
const controller = require('../../../controllers/admin/cms/cooperationContactContent.controller')
const { invalidateCooperationContactContent } = require('../../../middlewares/cache/cacheInvalidation.middleware')
