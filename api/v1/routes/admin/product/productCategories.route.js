...
const controller = require('../../../controllers/admin/product/productCategories.controller')
...
const { invalidateCategories } = require('../../../middlewares/cache/cacheInvalidation.middleware')
