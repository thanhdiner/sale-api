...
const controller = require('../../../controllers/admin/commerce/bankInfo.controller')
...
const { invalidateBankInfo } = require('../../../middlewares/cache/cacheInvalidation.middleware')
