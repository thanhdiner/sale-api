...
const controller = require('../../../controllers/admin/access/roles.controller')
...
router.patch('/permissions/:id', checkPermission.checkPermission('edit_role_permission'), controller.editPermissions)
