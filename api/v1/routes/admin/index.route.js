...
const productContentAssistantRoutes = require('./productContentAssistant.route')
...
const blogTagRoutes = require('./blogTag.route')
const blogAgentRoutes = require('./blogAgent.route')
const blogPublishQueueRoutes = require('./blogPublishQueue.route')
const cmsPageRoutes = require('./cmsPage.route')
const cmsRevisionRoutes = require('./cmsRevision.route')
const contentTranslationRoutes = require('./contentTranslation.route')
const mediaLibraryRoutes = require('./mediaLibrary.route')
