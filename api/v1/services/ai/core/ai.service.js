...
const { buildSystemPrompt, buildMessages } = require('../prompts/prompt.builder')
const conversationMemory = require('../memory/conversation.memory')
const { getToolDefinitions } = require('../tools/ai.tools')
const { PROCESS_FALLBACK_MESSAGE } = require('./ai.constants')
const { getClient, getActiveConfig, getRuntimeConfig } = require('../core/ai.config')
const {
